...
import PoliciPoliticConfirmation from '../components/PoliciPoliticConfirmation/PoliciPoliticConfirmation'
                ...
                <div className={styles.wrapper}>
                    <section>
                        ...
                        <p className={styles.visuallyHidden}>
                            Шитова Екатерина Вадимовна оказание консультационных
                            о здоровье
                        </p>
                    </section>
                    <Header />
